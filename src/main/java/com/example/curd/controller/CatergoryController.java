...
public class CatergoryController {
    ...
    Category createNewCategory(@RequestBody String newCategoryString) throws JsonMappingException, JsonProcessingException {
    	
    	ObjectMapper mapper = new ObjectMapper();
    	Category newCategory = mapper.readValue(newCategoryString, Category.class);
	...
	public List<Item> getItemsByCatergory( @PathVariable (value= "categoryId")Long categoryId, @RequestBody String item){
